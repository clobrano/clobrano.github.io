...
- theme
- opensource
title: Communitheme 11th stable release
---

The **Communitheme team** is happy to announce a new stable release!

The first stable release of July

- improves entry widget on headerbar
- begins a new style journey, this time about toolbar buttons (this to say that current version is not going to stay)
- adds a new improvement in Nemo support, with a better style of Places sidebar (more coming)
